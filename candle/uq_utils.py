...
def compute_statistics_homoscedastic_summary(
    df_data: DataFrame,
    col_true: int = 0,
    col_pred: int = 6,
    col_std_pred: int = 7,
    ...
    :param pandas dataframe df_data: Data frame generated by current CANDLE inference \
    ...
    :param int col_pred: Index of the column in the data frame where the predicted \
        value is stored (Default: 6, index in current CANDLE format).
    :param int col_std_pred: Index of the column in the data frame where the standard \
...
def compute_statistics_heteroscedastic(
    df_data: DataFrame,
    col_true: int = 4,
    ...
    frame. The latter includes all the individual inference realizations.

    :param pandas dataframe df_data: Data frame generated by current heteroscedastic inference \
        experiments. Indices are hard coded to agree with \
    ...
    :param int col_std_pred_start: Index of the column in the data frame where the first predicted \
