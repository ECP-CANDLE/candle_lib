...
class UQDistDict(TypedDict):
    ...
    expected for the parsing of UQ parameters for
...
def generate_index_distribution(numTrain: int, numTest: int, numValidation: int, params: UQDistDict) -> Tuple[Any, ...]:
...
def generate_index_distribution_from_fraction(numTrain: int, numTest: int, numValidation: int, params: UQDistDict) -> Tuple[Any, ...]:
    """ Generates a vector of indices to partition the data for training.
...
def generate_index_distribution_from_blocks(numTrain: int, numTest: int, numValidation: int, params: UQDistDict) -> Tuple[Any, ...]:
    """ Generates a vector of indices to partition the data for training.
        NO CHECKING IS DONE: it is assumed that the data could be partitioned
...
def generate_index_distribution_from_block_list(numTrain: int, numTest: int, numValidation: int, params: UQDistDict) -> Tuple[Any, ...]:
    """ Generates a vector of indices to partition the data for training.
        NO CHECKING IS DONE: it is assumed that the data could be partitioned
...
def compute_limits(numdata: int, numblocks: int, blocksize: int, blockn: int) -> Tuple[int, ...]:
...
def fill_array(blocklist: List[int], maxsize: int, numdata: int, numblocks: int, blocksize: int) -> Array:
...
def compute_statistics_homoscedastic_summary(df_data: DataFrame,
                                             col_true: int = 0,
                                             col_pred: int = 6,
                                             col_std_pred: int = 7,
                                             ) -> Tuple[Array, ...]:
...
def compute_statistics_homoscedastic(df_data: DataFrame,
                                     col_true: int = 4,
...
def compute_statistics_heteroscedastic(df_data: DataFrame,
                                       col_true: int = 4,
                                       col_pred_start: int = 6,
                                       col_std_pred_start: int = 7,
                                       ) -> Tuple[Array, ...]:
...
def split_data_for_empirical_calibration(Ytrue: Array, Ypred: Array, sigma: Array, cal_split: float = 0.8) -> Tuple[Array, ...]:
...
def compute_empirical_calibration_interpolation(pSigma_cal: Array, pPred_cal: Array, true_cal: Array, cv: int = 10):
